...
blocks:
  ...
  - type: concept
    ...
    explanation: |
      ...
      1. **Publish first**: Get the draft live
      2. **Use it**: Work through your own curriculum
      3. **Notice friction**: Where do you stumble?
      4. **Fix incrementally**: One improvement per session
...
**After**: "Lippmann argues that we don't react to the world—we react to 'pictures in our heads' that media creates. The news doesn't inform you about the world; it constructs the world you think you know."
...
This cadence means 52 improvements per year. After a year, your curriculum is genuinely refined—and you never burned out doing it.
